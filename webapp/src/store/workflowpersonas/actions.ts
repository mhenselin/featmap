...
export type createWorkflowPersona = {
  type: ActionTypes.CREATE_WORKFLOW_PERSONA;
  payload: IWorkflowPersona;
};
export const createWorkflowPersonaAction = (x: IWorkflowPersona) =>
  action(ActionTypes.CREATE_WORKFLOW_PERSONA, x);

export type loadWorkflowPersonas = {
  type: ActionTypes.LOAD_WORKFLOW_PERSONAS;
  payload: IWorkflowPersona[];
};
export const loadWorkflowPersonasAction = (x: IWorkflowPersona[]) =>
  action(ActionTypes.LOAD_WORKFLOW_PERSONAS, x);

export type updateWorkflowPersona = {
...
export const deleteWorkflowPersonaAction = (x: string) =>
  action(ActionTypes.DELETE_WORKFLOW_PERSONA, x);

export type Actions =
  | createWorkflowPersona
  | loadWorkflowPersonas
  | updateWorkflowPersona
