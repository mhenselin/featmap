...
class SubscriptionPage extends Component<Props, State> {
  ...
  render() {
    ...
    const priceOfBasic = process.env.REACT_APP_BASIC_PRICE
      ? parseInt(process.env.REACT_APP_BASIC_PRICE)
      : 0;
      ...
      <div>
        {this.state.loading ? (
          ...
          <div>
            {m.level !== Roles.OWNER ? (
              <div className="p-2">
                Only an owner of the workspace can change the workspace
                subscription. Please contact an owner.{" "}
              </div>
            ) : (
              <div>
                <div className="p-2">
                  ...
                  <div className="flex flex-col">
                    <Formik
                      initialValues={{
                        ...
                        nbrOfEditorsOnBasic: ns
                          ? this.nbrOfEditors()
                          : s.numberOfEditors,
                        nbrOfEditorsOnPro: ns
                          ? this.nbrOfEditors()
                          : s.numberOfEditors,
                      }}
                      validationSchema={Yup.object().shape({
                        action: Yup.string().required("Required."),
                        nbrOfEditorsOnBasic: Yup.number().min(
                          1,
                          "At least one editor is required"
                        ),
                        nbrOfEditorsOnPro: Yup.number().min(
                          1,
                          "At least one editor is required"
                        ),
                      })}
                      onSubmit={(
                        ...
                        actions: FormikActions<subscriptionForm>
                      ) => {
                        const quantity =
                          values.action === "basic"
                            ? values.nbrOfEditorsOnBasic
                            : values.nbrOfEditorsOnPro;

                        if (
                          values.action === "basic" &&
                          values.nbrOfEditorsOnBasic < this.nbrOfEditors()
                        ) {
                        ...
                        if (
                          values.action === "pro" &&
                          values.nbrOfEditorsOnPro < this.nbrOfEditors()
                        ) {
                          actions.setFieldError(
                            "nbrOfEditorsOnPro",
                            "Need to have at least " +
                        ...
                        <Form>
                          ...
                          <div className="flex flex-col ">
                            <div className="m-1 flex flex-col">
                              <Field name="level " component="div">
                                <div className="flex flex-row">
                                  <div className="flex w-8  items-center p-2 align-middle">
                                    <input
                                      type="radio"
                                      id="basic"
                                      defaultChecked={
                                        formikBag.values.action === "basic"
                                      }
                                      name="action"
                                      value="basic"
                                      className="h-5 w-5"
                                  ...
                                  <div className=" w-full">
                                    <CardLayout
                                      title={
                                        this.defaultAction() === "basic" && !ns
                                          ? "Team (current plan)"
                                          : "Team"
                                      }
                                    >
                                      <div>
                                        <div className="my-2 bg-gray-200 p-3">
                                        ...
                                        <ul className="list-reset ">
                                          ...
                                          <li className="mb-2 flex items-center">
                                            ...
                                            <div>
                                              Unlimited anonymous board viewers{" "}
                                            </div>
                                          </li>
                                          <li className="mb-2 flex items-center">
                                            <div className="mr-1">
                                      ...
                                      <div className="mt-4">
                                        ...
                                        <Field
                                          type="number"
                                          name="nbrOfEditorsOnBasic"
                                          className="ml-2 w-16 border p-2"
                                        />{" "}
                                        (This workspace currently has{" "}
                                        {this.nbrOfEditors()} editors)
                                      ...
                                      <div className="mt-2">
                                        ...
                                        <span className="text-lg font-medium">
                                          $
                                          {formikBag.errors.nbrOfEditorsOnBasic
                                            ? "0"
                                            : formikBag.values
                                                .nbrOfEditorsOnBasic *
                                              priceOfBasic}{" "}
                                  ...
                                  <div className="flex flex-row">
                                    ...
                                    <div className=" w-full">
                                      <CardLayout title="Cancel plan">
                                        ...
                                        <p>
                                          {" "}
                                          It will still be possible to access
                                          existing projects, but it will not be
                            ...
                            <div className=" m-1">
                              <Button
                                primary
                                submit
                                title={ns ? "Go to checkout" : "Change plan"}
                              />
                            </div>
                          </div>
                        </Form>
